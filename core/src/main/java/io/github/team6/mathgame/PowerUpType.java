...
/**
 * PowerUpType
 * Creates the three collectible power-ups in the game.
 *
 ...
 *
 * OOP: Open/Closed : adding a new power-up only requires a new enum value and a branch in PowerUpCollisionBehavior; no other classes change.
 */
