...
public class MathGameScene extends Scene {
    ...
    private HUDRenderer hudRenderer; // Handles all HUD drawing (Single Responsibility Principle)
    // -----------------------------------------------------------------
    // Gameplay SFX
    // -----------------------------------------------------------------
    ...
    public void onEnter() {
        ...
        //  Load Tiled map using LevelConfig
        LevelConfig levelConfig = LevelConfig.forLevel(GameStateManager.getInstance().getLevel());
        map         = new TmxMapLoader().load(levelConfig.mapFile);
        ...
        // render HUD
        float finishY = (planetZone != null) ? planetZone.y : mapPixelHeight;
        hudRenderer = new HUDRenderer(outputManager, equationGenerator,
            filledHeart, emptyHeart, progressIcon, equationBg, infoBg, finishY);
    ...
    public void render(SpriteBatch batch) {
        ...
        batch.begin();
        hudRenderer.render(batch, rocket.getY(), chaser);
        batch.end();
